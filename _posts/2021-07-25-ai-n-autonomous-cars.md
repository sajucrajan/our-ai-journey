...
description: Artificial Intelligence in Autonomous cars are two hot topics that need to be discussed together.  How can the travelling community gain confidence in autonomous cars to can be used to help in cybersecurity as well as to initiate cyber attacks!  What are the best ways AI can help overcome the vulnerabilities during development and testing to ensure a more secure delivery.
tags:
- ai
- cybersecurity
